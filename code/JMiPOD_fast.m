function [S_STRUCT, Deflection, pChange, ChangeRate ] = JMiPOD_fast (C_STRUCT, Payload)
% -------------------------------------------------------------------------
% J_MiPOD Embedding       |      January 2020       |      version 0.1 
% -------------------------------------------------------------------------
% INPUT:
%  - Cover       - Path to the cover image or JPEG STRUCT
...
% For example / demo to be removed for batch processing
fprintf("Hidden data lenght %5.2f bits = %d Nats \n", Payload * nzAC, messageLenght );
